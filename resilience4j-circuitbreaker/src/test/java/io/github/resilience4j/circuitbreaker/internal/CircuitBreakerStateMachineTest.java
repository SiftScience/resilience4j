...
public class CircuitBreakerStateMachineTest {
    ...
    private void assertCircuitBreakerMetricsEqualTo(CircuitBreaker circuitBreaker, Float expectedFailureRate, Integer expectedSuccessCalls, Integer expectedBufferedCalls, Integer expectedFailedCalls, Long expectedNotPermittedCalls) {
